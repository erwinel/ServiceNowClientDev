...
let newLine: string = x_44813_util.JsTypeCommander.getDefaultLineSeparatorSequence();
...
let testData: {
...
}[] = [
    {
        ...
        callback: x_44813_util.JsTypeCommander.trimStart,
        tests: [
        ...
        fName: 'trimEnd',
        signature: '(text: string): string',
        callback: x_44813_util.JsTypeCommander.trimEnd,
        tests: [
            { args: [""], expected: "" }, { args: [" "], expected: "" }, { args: ["\r"], expected: "" }, { args: ["\n"], expected: "" }, { args: [" \r\n "], expected: "" },
            { args: [" \r\n \r\n "], expected: "" },
            { args: ["Test \n\r\t Text"], expected: "Test \n\r\t Text" }, { args: [" Test \n\r\t Text "], expected: " Test \n\r\t Text" },
        ...
        signature: '(text: string): string',
        callback: x_44813_util.JsTypeCommander.asNormalizedWs,
        tests: [
            { args: [""], expected: "" }, { args: [" "], expected: "" }, { args: ["\r"], expected: "" }, { args: ["\n"], expected: "" }, { args: [" \r\n "], expected: "" },
            { args: [" \r\n \r\n "], expected: "" },
        ...
        fName: 'ucFirst',
        signature: '(text: string): string',
        callback: x_44813_util.JsTypeCommander.ucFirst,
        tests: [
        ...
        fName: 'splitLines',
        signature: '(text: string): string[]',
        callback: x_44813_util.JsTypeCommander.splitLines,
        tests: [
            { args: [""], expected: [""] }, { args: [" "], expected: [" "] }, { args: ["\r"], expected: ["", ""] }, { args: ["\n"], expected: ["", ""] },
        ...
        callback: x_44813_util.JsTypeCommander.indentText,
        tests: [
        ...
        fName: 'indentLines',
        signature: '(text: string|string[], indent?: string): string[]',
        callback: x_44813_util.JsTypeCommander.indentLines,
        tests: [
            { args: [""], expected: [""] }, { args: [" "], expected: [""] }, { args: ["\r"], expected: ["", ""] }, { args: ["\n"], expected: ["", ""] },
            { args: [" \r\n "], expected: ["", ""] },
            { args: [" \r\n \r\n "], expected: ["", "", ""] }, { args: [" \r\n \n\r "], expected: ["", "", "", ""] },
