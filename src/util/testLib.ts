...
export function describeTestFunction(this: any, expectations: (IExpectEquals|IExpectIs)[], funcDef: IFunctionDefinition, getGenericArgs?: { (): any|null|undefined; }) {
            ...
            if (e._type == "ExpectIs") {
                ...
                e.argSets.forEach(a => {
                    it(funcDef.name + "(" + a.display + ") should return " + e.display, function() {
                        ...
                        let tt: string = typeof(target);
                        if (tt == "object" && target === null)
                            tt = "null";
                        expect(tt).toBe(expectedType, a.message);
                    });
                }, this);
            } else {
                ...
                e.argSets.forEach(a => {
                    it(funcDef.name + "(" + a.display + ") should return " + e.display, function() {
                        ...
                        let target: any|null|undefined = funcDef.callback.apply(this, args);
                        expect(target).toBe(expected, a.message);
                    });
                }, this);
            }
        }, this);
...
export function describeExpectationSet(this: any, expectations: (IExpectEquals|IExpectIs)[], expectationSet: IExpectationSet) {
    let setFunc: { (this: any): void; } = function() {
...
export function describeFunctionGroups(this: any, expectations: (IExpectEquals|IExpectIs)[], functionGrp: IFunctionGroup) {
    let testFunc: { (this: any): void } = function() {
