...
describe("Testing type map functions", function () {
                        ...
                        args.forEach(function (argInfo) {
                            ...
                            it('JsTypeCommander.mapByTypeValue(' + argInfo.display + ', ' + JSON.stringify(tgh.toJSON()) + ((typeof (opt.checkElements) == "boolean") ? ", " +
                                ...
                                var result = (typeof (opt.checkElements) == "boolean") ?
                                    ...
                                    JsTypeCommander_1.x_44813_util.JsTypeCommander.mapByTypeValue.call(this, argInfo.getValue(), tgh);
                                dataIterationIndex++;
    ...
    var mapByNilFunctionArr = [
        { name: 'mapByDefined', callback: JsTypeCommander_1.x_44813_util.JsTypeCommander.mapByDefined, allowUndefined: false, allowNull: true },
        { name: 'mapByNotNull', callback: JsTypeCommander_1.x_44813_util.JsTypeCommander.mapByNotNull, allowUndefined: true, allowNull: false },
        { name: 'mapByNotNil', callback: JsTypeCommander_1.x_44813_util.JsTypeCommander.mapByNotNil, allowUndefined: false, allowNull: false }
    ];
