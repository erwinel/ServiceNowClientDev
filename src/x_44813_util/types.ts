namespace x_44813_util {
    export namespace types {
         ...
         * @returns {boolean} True if the value is a number and is not NaN; otherwise, false.
         */
        export function isInteger(value?: any) : value is number { return typeof(value) === "number" && !isNaN(value) && Math.round(value) === value; }
         ...
         */
        export function isNil(value?: any) : value is undefined|null { return !defined(value) || value === null; }
         ...
         */
        export function isNilOrEmptyString(value?: string|null) : boolean { return isNil(value) || (isString(value) && value.length == 0); }
         ...
         */
        export function isNilOrWhitespace(value?: string|null) : boolean { return isNil(value) || (isString(value) && whitespaceRegex.test(value)); }
         ...
         */
        export function derivesFrom<T>(value: any, classConstructor: { new(...args: any[]): T; }) : value is T {
            if (!defined(value))
        ...
        export function serializeToString(obj: any) : string {
            ...
            if (Array.isArray(obj)) {
                ...
                return "[" + newLineString + obj.map(function(e) {
                    ...
                    s.split(lineSplitRegex).map(function(l: string) { return "\t" + l; }).join(newLineString);
