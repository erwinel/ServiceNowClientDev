...
var newLine = JsTypeCommander_1.x_44813_util.JsTypeCommander.getDefaultLineSeparatorSequence();
var testData = [
    {
        fName: 'trimStart',
        signature: '(text: string): string',
        callback: JsTypeCommander_1.x_44813_util.JsTypeCommander.trimStart,
        tests: [
        ...
        fName: 'trimEnd',
        signature: '(text: string): string',
        callback: JsTypeCommander_1.x_44813_util.JsTypeCommander.trimEnd,
        tests: [
            { args: [""], expected: "" }, { args: [" "], expected: "" }, { args: ["\r"], expected: "" }, { args: ["\n"], expected: "" }, { args: [" \r\n "], expected: "" },
            { args: [" \r\n \r\n "], expected: "" },
            { args: ["Test \n\r\t Text"], expected: "Test \n\r\t Text" }, { args: [" Test \n\r\t Text "], expected: " Test \n\r\t Text" },
        ...
        signature: '(text: string): string',
        callback: JsTypeCommander_1.x_44813_util.JsTypeCommander.asNormalizedWs,
        tests: [
            { args: [""], expected: "" }, { args: [" "], expected: "" }, { args: ["\r"], expected: "" }, { args: ["\n"], expected: "" }, { args: [" \r\n "], expected: "" },
            { args: [" \r\n \r\n "], expected: "" },
        ...
        fName: 'ucFirst',
        signature: '(text: string): string',
        callback: JsTypeCommander_1.x_44813_util.JsTypeCommander.ucFirst,
        tests: [
        ...
        fName: 'splitLines',
        signature: '(text: string): string[]',
        callback: JsTypeCommander_1.x_44813_util.JsTypeCommander.splitLines,
        tests: [
            { args: [""], expected: [""] }, { args: [" "], expected: [" "] }, { args: ["\r"], expected: ["", ""] }, { args: ["\n"], expected: ["", ""] },
        ...
        callback: JsTypeCommander_1.x_44813_util.JsTypeCommander.indentText,
        tests: [
        ...
        fName: 'indentLines',
        signature: '(text: string|string[], indent?: string): string[]',
        callback: JsTypeCommander_1.x_44813_util.JsTypeCommander.indentLines,
        tests: [
            { args: [""], expected: [""] }, { args: [" "], expected: [""] }, { args: ["\r"], expected: ["", ""] }, { args: ["\n"], expected: ["", ""] },
            { args: [" \r\n "], expected: ["", ""] },
            { args: [" \r\n \r\n "], expected: ["", "", ""] }, { args: [" \r\n \n\r "], expected: ["", "", "", ""] },
...
describe("Testing string manipulation functions", function () {
    testData.forEach(function (f) {
        describe("Testing function " + f.fName + f.signature, function () {
