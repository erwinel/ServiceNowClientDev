...
describe("Testing regular expressions", function () {
    var patternDefinitions = [
        {
            name: 'onlyWhitespace', getRegex: function (regexOptions) { return (JsTypeCommander_1.x_44813_util.JsTypeCommander.notDefined(regexOptions)) ? undefined : regexOptions.onlyWhitespace; }, tests: [
            ...
            name: 'trimStart', getRegex: function (regexOptions) { return (JsTypeCommander_1.x_44813_util.JsTypeCommander.notDefined(regexOptions)) ? undefined : regexOptions.trimStart; }, tests: [
            ...
            name: 'trimEnd', getRegex: function (regexOptions) { return (JsTypeCommander_1.x_44813_util.JsTypeCommander.notDefined(regexOptions)) ? undefined : regexOptions.trimEnd; }, tests: [
                { input: "", expected: false }, { input: " \t\r\n ", expected: false }, { input: " \t\r\n ", expected: false },
            ...
            name: 'lineSeparator', getRegex: function (regexOptions) { return (JsTypeCommander_1.x_44813_util.JsTypeCommander.notDefined(regexOptions)) ? undefined : regexOptions.lineSeparator; }, tests: [
            ...
            name: 'booleanText', getRegex: function (regexOptions) { return (JsTypeCommander_1.x_44813_util.JsTypeCommander.notDefined(regexOptions)) ? undefined : regexOptions.booleanText; }, tests: (function () {
                var results = [
            ...
            name: 'firstLetterLc', getRegex: function (regexOptions) { return (JsTypeCommander_1.x_44813_util.JsTypeCommander.notDefined(regexOptions)) ? undefined : regexOptions.firstLetterLc; }, tests: [
            ...
            name: 'abnormalWhitespace', getRegex: function (regexOptions) { return (JsTypeCommander_1.x_44813_util.JsTypeCommander.notDefined(regexOptions)) ? undefined : regexOptions.abnormalWhitespace; }, tests: [
                { input: "  ", expected: { captures: [], groupZero: "  " } }, { input: " \t\r\n ", expected: { captures: [], groupZero: " \t\r\n " } },
    ...
    var regexOptionResult = (function () {
        var r;
        try {
            r = JsTypeCommander_1.x_44813_util.JsTypeCommander.getPatternOptions();
        }
        catch (_a) {
            r = undefined;
        }
